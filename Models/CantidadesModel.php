...
class CantidadesModel extends Query
{
    ...
    public function registrarCantidades(float $cantidad)
    {
        ...
        if (empty($existe)) {
            ...
            $sql = "INSERT INTO cantidades(cantidad) VALUES(?)";
    ...
    public function editarCantidad(int $id)
    {
        ...
        $sql = "SELECT * FROM cantidades WHERE id = $id";
    ...
    public function accionCantidad(int $estado, int $id)
    {
        ...
        $sql = "UPDATE cantidades SET estado = ? WHERE id = ?";
