...
class RutasModel extends Query
{
    ...
    private $ruta, $nombre, $clave, $telefono, $porcentaje, $id, $estado, $caja_inicial, $caja_anterior, $img;
    ...
    public function registrarRutas(string $ruta, string $clave, string $nombre, string $telefono, int $caja_inicial, int $porcentaje, string $img)
    {
        $this->ruta = $ruta;
        $this->clave = $clave;
        $this->nombre = $nombre;
        ...
        if (empty($existe)) {
            ...
            $sql = "INSERT INTO rutas(ruta, clave, nombre, telefono, caja_inicial, porcentaje, foto) VALUES(?, ?, ?, ?, ?, ?, ?)";
            ...
            $datos = array($this->ruta, $this->clave, $this->nombre, $this->telefono, $this->caja_inicial, $this->porcentaje, $this->img);
    ...
    public function modificarRutasClave(string $ruta, string $clave, string $nombre, string $telefono, int $caja_inicial, int $porcentaje, string $img, int $id)
    {
        $this->ruta = $ruta;
        $this->clave = $clave;
        $this->nombre = $nombre;
        ...
        $sql = "UPDATE rutas SET ruta = ?, clave = ?, nombre = ?, telefono = ?, caja_inicial = ?, porcentaje=?, foto = ? WHERE id = ?";

        //Se crea una variable que contiene el array donde indicamos las variables creadas con los this y esa variable se enviará a la carpeta config/App/Query.php
        $datos = array($this->ruta, $this->clave, $this->nombre, $this->telefono, $this->caja_inicial, $this->porcentaje, $this->img, $this->id);
    ...
    public function modificarRutas(string $ruta, string $nombre, string $telefono, int $caja_inicial, int $porcentaje, string $img, int $id)
    {
        $this->ruta = $ruta;
        $this->nombre = $nombre;
        $this->telefono = $telefono;
        ...
        //Se crea una variable sql donde se hace la consulta de actualizar los datos. Actualiza de la tabla trabajadores los campos
        $sql = "UPDATE rutas SET ruta = ?, nombre = ?, telefono = ?, caja_inicial = ?, porcentaje = ?, foto = ? WHERE id = ?";

        //Se crea una variable que contiene el array donde indicamos las variables creadas con los this y esa variable se enviará a la carpeta config/App/Query.php
        $datos = array($this->ruta, $this->nombre, $this->telefono, $this->caja_inicial, $this->porcentaje, $this->img, $this->id);
