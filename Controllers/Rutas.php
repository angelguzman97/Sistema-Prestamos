...
class Rutas extends Controller
{
    ...
    public function registrar()
    {
        ...
        //Se confirma
        if (empty($ruta) || empty($nombre) || empty($telefono) || empty($porcentaje)) {
            ...
            if ($id == "") {
                ...
                if ($clave != $confirmar) {
                    ...
                    $registrarRuta = $this->model->registrarRutas($ruta, $clave, $nombre, $telefono, $caja, $porcentaje, $imgNombre);
                ...
                if (empty($clave) & empty($confirmar)) {
                    ...
                    $data = $this->model->modificarRutasClave($ruta,  $_POST['contrasena'], $nombre, $telefono, $caja, $porcentaje, $imgNombre, $id);
                    //Se hace la verificación
                    if ($data == "modificado") {
                        $msg = "modificado";
                    } else {
                    ...
                    if ($clave != $confirmar) {
                        ...
                        //Se crea una variable que accede al modelo y se manda a llamar al método modificarRutas junto con sus parámetros en el modelo
                        $data = $this->model->modificarRutasClave($ruta, $clave, $nombre, $telefono, $caja, $porcentaje, $imgNombre, $id);
                        //Se hace la verificación
                        if ($data == "modificado") {
