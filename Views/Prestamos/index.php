                    ...
                    <div class="row">
                        ...
                        <div class="col-2 ms-4" style="text-align: center;">
                            <div class="form-group mt-2">
                                ...
                                <?php foreach ($data['porcentaje'] as $row) { ?>
                                    <input id="porcentaje" style="text-align: center; width: 60px;" value="<?php echo $row; ?>" class="form-control" name="porcentaje" readonly>
                                <?php } ?>
                            </div>
                        </div>
